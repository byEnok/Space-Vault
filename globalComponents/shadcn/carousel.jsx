...
const CarouselItem = React.forwardRef(({ className, ...props }, ref) => {
  ...
  return <div ref={ref} role='group' aria-roledescription='slide' className={cn('min-w-0 shrink-0 grow-0 basis-full w-full', orientation === 'horizontal' ? 'pl-4' : 'pt-4', className)} {...props} />
})
...
const CarouselPrevious = React.forwardRef(({ className, variant = 'outline', size = 'icon', ...props }, ref) => {
  ...
  return (
    <Button
      ...
      variant={variant}
      size={size}
      className={cn('absolute rounded-full h-6 w-6  md:h-8 md:w-8 ', orientation === 'horizontal' ? '-left-12 top-1/2 -translate-y-1/2' : '-top-12 left-1/2 -translate-x-1/2 rotate-90', className)}
